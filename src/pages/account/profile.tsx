...
const history=useHistory()
  ...
  <path d="M15 8l4 4" />
                ...
                <IonTitle>{t("My Account")} </IonTitle>
            </IonToolbar>
        </IonHeader>
        ...
        <input type="file" accept="images/*" style={{display:"none"}} ref={imgRef} onChange={(e)=>{
 ...
 if(file)
 {
  ...
  <path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" />
        ...
        variant="outlined" fullWidth margin="dense"
      />
      <input type="file" accept="images/*" ref={lRef} style={{display:"none"}}
      onChange={(e)=>{
...
className="icon icon-tabler icon-tabler-square-rounded-x" width="24" height="24" viewBox="0 0 24 24"
 strokeWidth="1.5" stroke="#ff2825" fill="none" strokeLinecap="round" strokeLinejoin="round">
  ...
  <path d="M12 3c7.2 0 9 1.8 9 9s-1.8 9 -9 9s-9 -1.8 -9 -9s1.8 -9 9 -9z" />
     ...
     onClick={()=>{
        setErrors({})
          axios.post('/api/profile',register).then(res=>{
